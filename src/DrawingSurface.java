...
public Hashtable getHierarchy() {
	if (hierarchy==null) {
		Hashtable groups = svp.parser.SVParser.parseGroups("SV_groups.txt");
 ...
 */
 public boolean open(String fileName) {
   	waitCursor();
	hierarchy = null;
  	data = svp.parser.SVParser.parse(fileName, view.getColorModel());
	if (data==null) {
...
public boolean readColorFile(String fileName) {
	DeviceColorModel colorModel = svp.parser.SVParser.parseColors(fileName);
	if (colorModel!=null) {
