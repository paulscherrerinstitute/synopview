...
import java.util.*;
import svp.devices.*;
import svp.visual.DeviceColorModel;
 ...
 */
public static DevicesData parse(String fileName, svp.visual.DeviceColorModel colorModel) {
...
public static svp.visual.DeviceColorModel parseColors(String fileName) {
 ...
 * @param colorModel svp.visual.DeviceColorModel
 */
public static void processData(DevicesData data, svp.visual.DeviceColorModel colorModel, StreamTokenizer tokenizer, String fileName) {
	...
	try	{
		while (tokenizer.nextToken() != tokenizer.TT_EOF)
			...
			data.addDevice(new svp.devices.SimpleDevice(name, parent, cmd, machine, system, color, new java.awt.Polygon(x, y, i), colorModel));
